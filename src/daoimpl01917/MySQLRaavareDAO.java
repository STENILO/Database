...
public class MySQLRaavareDAO implements RaavareDAO {
	...
	public void createRaavare(RaavareDTO raavare) throws DALException {
		Connector.doUpdate(
				"INSERT INTO operatoer (raavare_id, raavare_navn, leverandoer) VALUES " + "( " + raavare.getRaavareId() +
	...
	public void updateRaavare(RaavareDTO raavare) throws DALException {
		Connector.doUpdate ( 
				"UPDATE raavare SET raavare_Navn = '" + raavare.getRaavareId() + "', leverandoer = '" + raavare.getLeverandoer() 
